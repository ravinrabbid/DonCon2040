...
constexpr Utils::I2c::Config pad_i2c_config = {
    .sda_pin = 14,
    .scl_pin = 15,
    .block = i2c1,
    .speed_hz = 1000000,
...
constexpr Peripherals::Controller::Config controller_config = {
    .pins =
        {
            .dpad =
                {
    ...
    .gpio_config =
        Peripherals::Controller::Config::ExternalGpio{
            .i2c =
                {
                    .block = pad_i2c_config.block,
                    .address = 0x20,
                },
        },
};

constexpr Peripherals::StatusLed::Config led_config = {
...
constexpr Peripherals::Display::Config display_config = {
    .i2c_block = pad_i2c_config.block,
    .i2c_address = 0x3C,
};

constexpr Proprietary::DeviceConfig proprietary_device_config = std::monostate{};
// constexpr Proprietary::DeviceConfig proprietary_device_config = Proprietary::WiimoteExtensionDriver::Config{
//     .sda_pin = 0,
//     .scl_pin = 1,
//     .block = i2c0,
//     .speed_hz = 400000,
// };
// constexpr Proprietary::DeviceConfig proprietary_device_config = Proprietary::PsxDigitalPadDriver::Config{
//     .base_pin = 4,
// };
